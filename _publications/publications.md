...
<div class="publication">
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.BAE2025.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.BAE2025.count }}</a>
</div>
...
<div class="publication"> 
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.BAE2023.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.BAE2023.count }}</a>
</div>
...
<div class="publication">
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.UFUG2021.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.UFUG2021.count }}</a>
</div>
...
<div class="publication">
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.UECO2021.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.UECO2021.count }}</a>
</div>
...
<div class="publication">
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.UECO2023.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.UECO2023.count }}</a>
</div>
...
<div class="publication">
    <strong>Scopus Citations:</strong> <a href="{{ site.data.citations.LANDUP2023.url }}" target="_blank" style="text-decoration: none; color: blue;">{{ site.data.citations.LANDUP2023.count }}</a>
</div>
